...
public class GmailSender {
    ...
    private static final String FROM = "lossolesutez@gmail.com";
    private final Gmail service;
    public GmailSender() throws Exception {
        NetHttpTransport httpTransport = GoogleNetHttpTransport.newTrustedTransport();
        GsonFactory jsonFactory = GsonFactory.getDefaultInstance();
        service = new Gmail.Builder(httpTransport, jsonFactory, getCredentials(httpTransport, jsonFactory))
                .setApplicationName("SolesUTEZ")
                .build();
    }
    ...
    public static void main(String[] args) throws Exception {
       /* new GmailSender().sendMail("dericklagunes@utez.edu.mx","SolesUtezDeLaUtez",
                "<h1>Integrantes</h1>" +
                        "<p>Ramirez Lopez Alicia Fernanda</p>" +
                        "<p>Murga Arcos Angel Santiago</p> *" +
                        "<p>Garcia Salgado Erick</p> *" +
                        "<p>Gomez Nava Diego Daniel</p> *" +
                        "<p>Jimenez Barcelata Isaac</p> *" +
                        "<p>Delgado Velazquez Josue Jafet</p> *");
